...
class Exercice(models.Model):
    ...
    node_id = models.ForeignKey(Node, on_delete=models.PROTECT, blank=False, null=False, related_name='exercices')
    student_id = models.ForeignKey(Student, on_delete=models.CASCADE, blank=False, null=False, related_name='exercices')
